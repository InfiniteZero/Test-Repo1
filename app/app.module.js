(function(){ //self invoking anonymous function to make sure code runs
  ...
  var app = angular.module('myApp', []); //declaring your angular app here. THe array in the second argument is a list of dependencies (e.g. angular or vendor libraries)
